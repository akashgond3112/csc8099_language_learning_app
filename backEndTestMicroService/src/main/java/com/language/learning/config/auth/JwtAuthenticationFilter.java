package com.language.learning.config.auth;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (request.getServletPath().contains("/auth") || request.getServletPath().contains("/user/**")) {
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (Boolean.TRUE.equals(jwtTokenHelper.validateTokenUsingUserName(jwt.substring("Bearer ".length()), userEmail))) {
